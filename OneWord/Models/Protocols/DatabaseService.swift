...
protocol DatabaseService: Actor {
    ...
    func add<Child: TwoParentsChildRecord>(_ record: Child, withParent parent: Child.Parent, andSecondParent: Child.SecondParent) async throws -> Child
    func fetch<SomeRecord: Record>(withID recordID: String) async throws -> SomeRecord
    func update<Child: ChildRecord>(_ record: Child, addingParent parent: Child.Parent) async throws -> Child
